...
var Vector2 = function () {
  ...
  _createClass(Vector2, [{
    ...
    value: function toString() {
      var description = "[x: " + this._x + ", y: " + this._y + "] length: " + this.length;
      return description;
    }
  }, {
    key: "x",
...
var _assetManager = __webpack_require__(333);

var _assetManager2 = _interopRequireDefault(_assetManager);

var _inputManager = __webpack_require__(336);

var _inputManager2 = _interopRequireDefault(_inputManager);

var _entitiesManager = __webpack_require__(337);
...
var _engine = __webpack_require__(128);
...
var _primitivesRendering = __webpack_require__(339);
...
function init() {
  var AXIS_OFFSET = 5;
  var xAxisStart = new _vector2.default(AXIS_OFFSET, this.canvasHeight / 2);
  var xAxisEnd = new _vector2.default(this.canvasWidth - AXIS_OFFSET, this.canvasHeight / 2);
  var yAxisStart = new _vector2.default(this.canvasWidth / 2, AXIS_OFFSET);
  var yAxisEnd = new _vector2.default(this.canvasWidth / 2, this.canvasHeight - AXIS_OFFSET);
  var configuration = { xStart: xAxisStart, xFinish: xAxisEnd,
  ...
  graph = new _graph2.default(configuration);
...
function render(deltaTime) {
  ...
  for (var index = 0; index < values.length - 1; index++) {
    var pointA = values[index];
    var pointB = values[index + 1];

    (0, _primitivesRendering.drawLine)(this._canvasContext, pointA, pointB, '#FF0000', 2);
  }
...
function generateValues(startingValue, endingValue, resolution) {
  var values = [];
  for (var value = startingValue; value <= endingValue; value += resolution) {
    values.push(new _vector2.default(Math.cos(value), Math.sin(value)));
  }
  return values;
}
...
var _observable = __webpack_require__(129);
...
var _jsonLoader = __webpack_require__(335);
...
var EntitiesManager = (_class = function () {
  ...
  _createClass(EntitiesManager, [{
    ...
    key: "addAtGroup",
    value: function addAtGroup(id, groupName, entity) {
    ...
    value: function remove(id) {
      if (this._entities.has(id)) {
        var groups = Array.from(this._groups.keys());
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;
    ...
    key: "removeFromGroup",
    value: function removeFromGroup(id, groupName) {
    ...
    value: function getGroup(groupName) {
      if (this._groups.has(groupName)) {
        var ids = this._groups.get(groupName).values();
...
}(), (_applyDecoratedDescriptor(_class.prototype, "add", [_validator.validateNullUndifined, _validator.validateEmptyString], Object.getOwnPropertyDescriptor(_class.prototype, "add"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "addAtGroup", [_validator.validateNullUndifined, _validator.validateEmptyString], Object.getOwnPropertyDescriptor(_class.prototype, "addAtGroup"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "remove", [_validator.validateEmptyString], Object.getOwnPropertyDescriptor(_class.prototype, "remove"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "removeFromGroup", [_validator.validateEmptyString], Object.getOwnPropertyDescriptor(_class.prototype, "removeFromGroup"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "removeGroup", [_validator.validateEmptyString], Object.getOwnPropertyDescriptor(_class.prototype, "removeGroup"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "get", [_validator.validateEmptyString], Object.getOwnPropertyDescriptor(_class.prototype, "get"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "getGroup", [_validator.validateEmptyString], Object.getOwnPropertyDescriptor(_class.prototype, "getGroup"), _class.prototype)), _class);
...
var Graph = function () {
  ...
  _createClass(Graph, [{
    key: "_drawAxis",
    value: function _drawAxis(canvasContext, width, height) {

      (0, _primitivesRendering.drawLine)(canvasContext, this._xAxis.start, this._xAxis.finish, this._axisColor, this._axisWidth);
      (0, _primitivesRendering.drawLine)(canvasContext, this._yAxis.start, this._yAxis.finish, this._axisColor, this._axisWidth);

      this._drawDivisions(canvasContext, this._xAxis);
    }
  }, {
    key: "_drawDivisions",
    value: function _drawDivisions(canvasContext, axis) {
      var divisions = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;

      var numericStep = 1;
      var spatialStep = (axis.finish.x - axis.start.x) / divisions;

      var start = new _vector2.default(axis.start.x, axis.start.y - 5);
      var finish = new _vector2.default(axis.start.x, axis.start.y + 5);
      var x = axis.start.x;
      for (var index = axis.minValue; index < axis.maxValue; index += numericStep) {
        (0, _primitivesRendering.drawLine)(canvasContext, new _vector2.default(x, start.y), new _vector2.default(x, finish.y), this._axisColor, this._axisWidth);
...
exports.drawFilledShape = exports.drawLine = undefined;
...
function drawFilledShape(canvasContext, points) {
...
exports.drawFilledShape = drawFilledShape;
